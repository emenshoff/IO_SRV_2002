...
struct xdr_ops
	{
		bool_t	(*x_getlong)(struct xdr*,long*);	/* get a long from underlying stream */
		bool_t	(*x_putlong)(struct xdr*,long*);	/* put a long to " */
		bool_t	(*x_getbytes)(struct xdr*,caddr_t,u_int);/* get some bytes from " */
		bool_t	(*x_putbytes)(struct xdr*,caddr_t,u_int);/* put some bytes to " */
		u_int	(*x_getpostn)(struct xdr*);/* returns bytes off from beginning */
		bool_t  (*x_setpostn)(struct xdr*,u_int);/* lets you reposition the stream */
		long *	(*x_inline)(struct xdr*,int);	/* buf quick ptr to buffered data */
		void	(*x_destroy)(struct xdr*);	/* free privates of this xdr_stream */
	};
/*
 * The XDR handle.
 ...
 */
extern bool_t	xdr_void(XDR *xdrs,caddr_t addr);
...
extern void   xdrrec_create(XDR*,u_int,u_int,caddr_t,int (*readit)(),int (*writeit)());
